...
Diagnostic = np.genfromtxt('WDBC.dat', delimiter=',', usecols=1, dtype=str) #Cargar los diagnosticos por aparte
...
print("La primera matriz es la de autovalores y despues la autovectores respectivos para cada autovalor: ") 	            #Imprimo los autovalores y autovectores
print(valores)
print('\n')
print(vectores)
print('\n')
